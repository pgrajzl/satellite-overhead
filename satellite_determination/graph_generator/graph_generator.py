...
class GraphGenerator:
    ...
    def generate_graph(self):
        ...
        plt.bar(size_x_axis - 0.2, num_sats_above_horizon, 0.4, label="Satellites above the horizon")
        plt.bar(size_x_axis + 0.2, num_sats_beam, 0.4, label='Satellites crossing main observation beam')
        plt.xlabel("Hour (UTC)")
