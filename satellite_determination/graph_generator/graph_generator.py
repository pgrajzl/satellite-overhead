...
how many total satellites are above the horizon during the search window. It require the
search window and a list of satellites that will interfere with the main observation beam
(generated by the EventFinderRhodesmill.get_overhead_windows_slew) and the satellites
visible above the horizon (generated by EventFinderRhodesmill.get_overhead_windows).
'''
